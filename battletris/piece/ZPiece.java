...
public class ZPiece extends PieceImpl
{
	...
	public ZPiece(Board b)
	{
		...
		// top
		m_blocks[1] = makeBlockAt(Board.BLOCK_TYPE_Z, -1, 0, DEFAULT_COLOR);

		// bottom
		m_blocks[2] = makeBlockAt(Board.BLOCK_TYPE_Z, 0, 1, DEFAULT_COLOR);

		// bottom right
		m_blocks[3] = makeBlockAt(Board.BLOCK_TYPE_Z, 1, 1, DEFAULT_COLOR);
	}
}
