...
public class HaveANiceDay extends Weapon implements StaticBoardModWeaponType
{
	/**
	 * 
	 */
	...
	public HaveANiceDay(String name, String desc, Integer duration, Integer cost)
	{
	...
	public Object clone()
	{
		HaveANiceDay l_other = new HaveANiceDay(this.m_name, this.m_description, this.m_duration, this.m_cost);
